package com.smartbrightness.refreshview;
...
import com.smartbrightness.refreshview.interfaces.AppBarStateListener;
import com.smartbrightness.refreshview.interfaces.ILoadMoreFooter;
import com.smartbrightness.refreshview.interfaces.IRefreshHeader;
...
public class LRecyclerView extends RecyclerView {
    ...
    private LRecyclerAdapter mWrapAdapter;
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mWrapAdapter = (LRecyclerAdapter) adapter;
    ...
    private class DataObserver extends AdapterDataObserver {
        ...
        public void onChanged() {
            ...
            if (adapter instanceof LRecyclerAdapter) {
                LRecyclerAdapter lRecyclerViewAdapter = (LRecyclerAdapter) adapter;
    ...
    public void setLoadMoreEnabled(boolean enabled) {
        if (mWrapAdapter == null) {
            throw new NullPointerException("LRecyclerAdapter cannot be null, please make sure the variable mWrapAdapter have been initialized.");
        }

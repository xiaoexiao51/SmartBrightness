...
public class DefultHeader extends LinearLayout implements IRefreshHeader {
    ...
    public void onMove(float offSet, float sumOffSet) {
        ...
        // 设置下拉刷新时间
        long refresh_time = SPUtils.getLong(getContext().getApplicationContext(), "refresh_time", 0);
        mHeaderTimeView.setText(friendlyTime(refresh_time));
    }
    ...
    public void onComplete() {
        ...
        SPUtils.saveLong(getContext().getApplicationContext(), "refresh_time", refresh_time);

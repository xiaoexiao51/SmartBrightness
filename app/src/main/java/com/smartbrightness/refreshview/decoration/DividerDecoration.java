package com.smartbrightness.refreshview.decoration;
...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof LRecyclerAdapter) {
            headerCount = ((LRecyclerAdapter) parent.getAdapter()).getHeaderViewsCount() + 1;
            footerCount = ((LRecyclerAdapter) parent.getAdapter()).getFooterViewsCount();
        }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof LRecyclerAdapter) {
            headerCount = ((LRecyclerAdapter) parent.getAdapter()).getHeaderViewsCount() + 1;
            footerCount = ((LRecyclerAdapter) parent.getAdapter()).getFooterViewsCount();
            dataCount = ((LRecyclerAdapter) parent.getAdapter()).getItemCount() - headerCount - footerCount;
        } else {
